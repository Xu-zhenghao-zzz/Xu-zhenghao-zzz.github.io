...
- [x] Replace the homepage placeholder CV with a factual academic CV (`assets/pdf/cv.pdf`). Filename unchanged.
- [x] Compress About, delete Research Interests, and rewrite Research Experience as real projects.
...
- [ ] Add GitHub URLs after release, and a GRACE code link only with collaborator approval.
- [ ] Optional: add Google Scholar, ORCID, or LinkedIn identifiers in `_data/profile.yml`.
